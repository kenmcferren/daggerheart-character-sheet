...
- **Tip the Scales - Passive:** PCs can gain advantage on a Presence Roll by offering a handful of gold as part of the interaction. Will any coin be accepted, or only local currency? How overt are the PCs in offering this bribe?
...
> Source: Daggerheart SRD 2.0, p. 161. Rules: [Environments.md](../Environments.md)
