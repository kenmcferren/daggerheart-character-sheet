...
- **Hellfire - Action:** Spend a Fear to rain down hellfire within Far range. All targets within the area must make an Agility Reaction Roll. Targets who fail take 1d20+3 magic damage.
...
> Source: Daggerheart SRD 2.0, p. 104. Rules: [Adversaries.md](../Adversaries.md)
