...
- The PDF's own table of contents and page footers are not reproduced; [SRD Index.md](SRD%20Index.md) replaces the contents page.
...
- Character Creation Step 2 lists Earthkin, Emberkin, Skykin and Tidekin as separate ancestries; the Ancestries section groups them under "Elemental Kin". Here: an [Elemental Kin](Ancestries/Elemental%20Kin.md) overview plus four separate files.
...
- Where the PDF lays a bulleted list beside a paragraph in two columns (for example the Colossus stat block lists in [Colossal Adversaries](Supplemental%20Campaign%20Mechanics/Colossal%20Adversaries.md)), two blocks may run together in one paragraph.
