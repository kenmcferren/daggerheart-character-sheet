...
**Classes with access:** [Bard](../Classes/Bard%20Class.md), [Wizard](../Classes/Wizard%20Class.md)

**Card rules:** [Domain Cards.md](Domain%20Cards.md) (level, recall cost, loadout and vault).

> Source: Daggerheart SRD 2.0, Domains pp. 7–8; cards from the Appendix, pp. 206–224. 21 cards.

## Card List

| Card | Level | Type | Recall Cost |
|---|---|---|---|
| Book of Ava | 1 | Grimoire | 2 |
| Book of Illiat | 1 | Grimoire | 2 |
| Book of Tyfar | 1 | Grimoire | 2 |
| Book of Sitil | 2 | Grimoire | 2 |
| Book of Vagras | 2 | Grimoire | 2 |
| Book of Korvax | 3 | Grimoire | 2 |
| Book of Norai | 3 | Grimoire | 2 |
| Book of Exota | 4 | Grimoire | 3 |
| Book of Grynn | 4 | Grimoire | 2 |
| Manifest Wall | 5 | Spell | 2 |
| Teleport | 5 | Spell | 2 |
| Banish | 6 | Spell | 0 |
| Sigil of Retribution | 6 | Spell | 2 |
| Book of Homet | 7 | Grimoire | 0 |
| Codex-Touched | 7 | Ability | 2 |
| Book of Vyola | 8 | Grimoire | 2 |
| Safe Haven | 8 | Spell | 3 |
| Book of Ronin | 9 | Grimoire | 4 |
| Disintegration Wave | 9 | Spell | 4 |
| Book of Yarrow | 10 | Grimoire | 2 |
| Transcendent Union | 10 | Spell | 1 |
...
Arcane Barrage: Once per rest, spend any number of Hope and shoot magical projectiles that strike a target of your choice within Close range. Roll a number of d6s equal to the Hope spent and deal that much magic damage to the target. Telepathy: Spend a Hope to open a line of mental communication with one target you can see. This connection lasts until your next rest or you cast Telepathy again.
